...
for(const entry of ['index.html','v2/index.html']){
  ...
  if(/auth-gate\.js/i.test(html))errors.push(`${entry} todavía ejecuta auth-gate.js; debe existir un solo bootstrap`);
...
console.log(`TannerOS static QA OK · ${htmlFiles.length} pantallas protegidas revisadas · bootstrap único verificado`);
