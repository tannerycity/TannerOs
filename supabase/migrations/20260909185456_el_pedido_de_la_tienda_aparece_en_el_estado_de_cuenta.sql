-- La tienda lleva su contabilidad en app.orders, no en app.charges: hay 46
-- pedidos y cero cargos de uniforme. Al mostrar los pagos de tienda sin su
-- pedido, la familia veia un abono suelto y no cuadraba.
--
-- Ahora el pedido aparece como movimiento con su folio y su total, junto al
-- pago que lo cubre. El adeudo de arriba NO cambia: sigue saliendo de
-- charge_balances, que es la fuente de verdad de las mensualidades.
