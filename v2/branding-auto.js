...
async function boot(){
  ...
  ensureCss('/icons.css?v=20260907a','tosIconsCss');ensureCss('/polish.css?v=20260907a','tosPolishCss');ensureCss('/v2/shell.css?v=20260907d','tosShellCss');ensureCss('/v2/experience.css?v=20260823a','tosExperienceCss');ensureCss('/v2/production.css?v=20260823a','tosProductionCss');
