...
async function loadPlayers(){players=await rpc('v2_players',{organization_id:ctx.organization_id,status_filter:null})||[];await signPlayerPhotos(players);renderStats();renderDemographics();buildCatChips();renderList();}
