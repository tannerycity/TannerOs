...
export const EXPERIENCE_MODULES=[
  ...
  {code:'patrocinadores',label:'Patrocinios',href:'/v2/patrocinadores/',group:'ops',icon:'briefcase'},
...
const PATH_META=[
  ...
  ['/v2/patrocinadores/','patrocinadores','Patrocinios','/v2/direccion/'],
...
const COMMANDS=[
  ...
  {terms:['patrocinadores','patrocinios','sponsors','sponsor','marcas'],title:'Abrir Patrocinios',subtitle:'Ruta de marcas y acuerdos',href:'/v2/patrocinadores/',module:'patrocinadores',icon:'briefcase'},
