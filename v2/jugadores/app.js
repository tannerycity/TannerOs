...
function renderStats(){
  ...
  const cards=[['active',jugadores,'Jugadores',''],['cat',categorias,'Categorías',''],['withdrawn',bajas,'Bajas',''],['review',exp,'Cobro por revisar','danger']];
