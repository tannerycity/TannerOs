-- Tres datos nuevos al FINAL de la lista de Tanners: los dos consentimientos y
-- el tipo de beca. Van al final a propósito: renombrar o reordenar columnas de
-- una RPC ya publicada rompe la pantalla que la consume.
...
-- Crear una función en private la deja abierta a PUBLIC por default.
