...
begin
  ...
  select coalesce(jsonb_agg(jsonb_build_object(
    ...
    -- Al final: las pantallas que ya leen este objeto no cambian de forma.
    'photoPath',p.photo_path,'photoThumbPath',p.photo_thumb_path,'photoBucket',p.photo_bucket
...
revoke all on function private.query_catalog(uuid) from public, anon, authenticated;;
